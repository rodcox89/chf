...
_magic_number = 10
_modified_time = 1425790619.958845
_enable_loop = True
...
def render_shopcontent(context,**pageargs):
    ...
    try:
        ...
        items = context.get('items', UNDEFINED)
        __M_writer = context.writer()
        __M_writer('\n    <div class="items">\n        <div class="container">\n            <div class="row">\n                <div class="col-md-12">\n                    <h2 class="title">The Coolest Products Around</h2>\n                </div>\n                <div id="item-loop">\n')
        for item in items:
...
"""
__M_BEGIN_METADATA
{"source_encoding": "ascii", "filename": "/Users/rodneycox/chf/shop/templates/items.html", "uri": "items.html", "line_map": {"64": 33, "65": 33, "66": 35, "35": 1, "68": 41, "40": 45, "74": 68, "46": 3, "59": 18, "67": 35, "53": 3, "54": 11, "55": 12, "56": 17, "57": 17, "58": 18, "27": 0, "60": 25, "61": 25, "62": 29, "63": 29}}
__M_END_METADATA
"""
